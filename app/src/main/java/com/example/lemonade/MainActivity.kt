...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnClickListener {
            // Added: call the method that handles the state when the image is clicked
            clickLemonImage()
        }
        lemonImage!!.setOnLongClickListener {
            // Added: replace 'false' with a call to the function that shows the squeeze count
            showSnackbar()
        }
    }
    ...
    private fun clickLemonImage() {
        // Added: use a conditional statement like 'if' or 'when' to track the lemonadeState
        ...
        // Added: When the image is clicked in the SELECT state, the state should become SQUEEZE
        ...
        // Added: When the image is clicked in the SQUEEZE state the squeezeCount needs to be
        ...
        // Added: When the image is clicked in the DRINK state the state should become RESTART

        // Added: When the image is clicked in the RESTART state the state should become SELECT

        // Added: lastly, before the function terminates we need to set the view elements so that the
